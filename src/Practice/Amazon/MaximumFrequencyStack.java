...
public class MaximumFrequencyStack {
    ...
    HashMap<Integer, Stack<Integer>> freqToElements;
    int maxFreq;
    ...
    public void push(int x) {
        ...
        freqToElements.computeIfAbsent(f, k -> new Stack()).push(x);
    }

    public int pop() {
        int x = freqToElements.get(maxFreq).pop();
        frequency.put(x, maxFreq);
        if (freqToElements.get(maxFreq).size() == 0)
            maxFreq--;
        return x;
    }
